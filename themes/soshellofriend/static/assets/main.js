!(function () {
    ...
    (e = document.querySelector(".container")),
        ...
        (s = function () {
            n && n.classList.toggle("hidden", !c()), t && t.classList.toggle("hidden", c()), i && i.classList.toggle("hidden", !c());
        }),
        t &&
        ...
        document.body.addEventListener("click", function () {
            c() || !i || i.classList.contains("hidden") ? c() && !t.classList.contains("hidden") && t.classList.add("hidden") : i.classList.add("hidden");
        }),
        ...
        o &&
            o.addEventListener("click", function (t) {
                t.stopPropagation(), i && i.classList.toggle("hidden"), i && i.getBoundingClientRect().right > e.getBoundingClientRect().right && ((i.style.left = "auto"), (i.style.right = 0));
            }),
