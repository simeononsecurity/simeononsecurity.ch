...
date: 2020-10-07
draft: false
description: 「フェルネット暗号とマルボゲ暗号を解読して、HackTheBox 暗号チャレンジを解決し、隠されたフラグを明らかにする方法を学びましょう。」
tags: [「ハックザボックス」、「挑戦」、「暗号」、「デコード」、"書き上げる"、「フェルネット暗号」、「マルボッジ暗号」、「対称暗号化」、"サイバーセキュリティ"、「暗号化」、「侵入テスト」、「パイソン」、"安全"、"チャレンジ"、「CTF」、"国旗"、「暗号化」、「復号化」、「Base64」]
toc: true
cover: "/img/cover/A_cartoon_hacker_standing_next_to_a_large_lock_with_one_hand.png"
coverAlt: 「漫画のハッカーが大きな錠の横に立ち、片手でフェルネットのロゴの鍵を持ち、もう一方の手でマルボゲのロゴの鍵を持ち、鍵の内側に旗が見える。」
coverCaption: 「」
---
