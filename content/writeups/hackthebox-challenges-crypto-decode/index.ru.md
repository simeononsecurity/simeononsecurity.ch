---
title: «HackTheBox — Проблемы — Крипто — Расшифровка»
date: 2020-10-07
draft: false
description: «Узнайте, как расшифровывать шифры Фернета и Мальбоге, чтобы решить задачу HackTheBox Crypto Challenge и раскрыть скрытый флаг».
tags: ["ХакБокс",«Вызовы»,"Крипто","Расшифровать","Записать","Фернет Шифр",«Шифр Мальбоге»,«Симметричное шифрование»,"Информационная безопасность","Криптография","Проверка на проницаемость","Питон","Безопасность","Испытание","КТФ","Флаг","Шифрование","Расшифровка","Бейс64"]
toc: true
cover: "/img/cover/A_cartoon_hacker_standing_next_to_a_large_lock_with_one_hand.png"
coverAlt: «Мультяшный хакер стоит рядом с большим замком, в одной руке он держит ключ с логотипом Fernet, а в другой — ключ с логотипом Malboge, а внутри замка виден флаг»
coverCaption: ""
---
