---
title: «HackTheBox — Проблемы — Криптовалюта — Ограбление банка»
date: 2020-10-07
draft: false
toc: true
description: "Learn how to decode T9/Multitap and Atbash ciphers to solve the Bank Heist challenge on HackTheBox."
tags: ["взломать бокс","криптография",«Шифр Т9»,"многократный шифр","шифр атбаш","информационная безопасность","расшифровать","шифрованный текст","испытание","флаг","информационная безопасность","взлом","учиться","руководство","расшифровка шифра","разгадывание головоломок","взлом кода","вызов криптографии",«навыки кибербезопасности»,"онлайн обучение"]
