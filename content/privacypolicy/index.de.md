---
title: "Datenschutzrichtlinien: Sammlung von Informationen, Nutzung und Zustimmung | SimeonOnSecurity"
date: 2020-08-08
---
...
Wir arbeiten mit Google AdSense und Analytics zusammen, um Ihre Website-Erfahrung zu optimieren, unsere Produkte/Dienstleistungen zu verbessern und unsere Angebote effektiv zu vermarkten. Diese Dienste beinhalten die Verwendung von Cookies und anderen Tracking-Technologien, sowohl von Erstanbietern als auch von Drittanbietern, um Daten über Ihre Interaktionen und Ihr Verhalten beim Surfen auf unserer Website zu sammeln.

Durch den Einsatz von Google AdSense können wir Ihnen gezielte Werbung auf der Grundlage Ihrer früheren Besuche auf unserer Website und anderen Websites anzeigen. Diese personalisierte Werbung wird durch die Verwendung von Werbe-Cookies ermöglicht. Darüber hinaus können wir mit Google Analytics wertvolle Einblicke in den Website-Verkehr, das Nutzerengagement und andere Messgrößen gewinnen, um die Leistung unserer Website zu verbessern.

Um Transparenz und Kontrolle über Ihre Einstellungen zur Anzeigenpersonalisierung zu erhalten, können Sie die [Ads Settings](https://www.google.com/settings/ads) page to opt out of personalized advertising. Alternatively, you may choose to visit [www.aboutads.info](http://www.aboutads.info/choices/) um personalisierte Werbung von Drittanbietern, die Cookies verwenden, abzulehnen. Bitte beachten Sie, dass auch andere Anbieter und Werbenetzwerke Cookies verwenden können, um Anzeigen auf unserer Website zu schalten, wenn Sie sich nicht gegen die Anzeigenschaltung durch Dritte entschieden haben.

Da die Datenschutzrichtlinien und -bestimmungen von Land zu Land und von Verlag zu Verlag unterschiedlich sein können, sind wir nicht in der Lage, spezifische Formulierungen für Ihre Datenschutzrichtlinien bereitzustellen. Wir empfehlen jedoch, Ressourcen wie die folgenden zu konsultieren [Network Advertising Initiative](http://www.networkadvertising.org/) or reviewing [cookiechoices.org](http://cookiechoices.org/) um eine Anleitung für die Erstellung einer umfassenden Datenschutzrichtlinie zu erhalten.

Weitere Informationen darüber, wie Google Daten über AdSense und Analytics sammelt und verwendet, finden Sie in der [Google Privacy Policy](https://policies.google.com/privacy)

### Microsoft Clarity

*Wir arbeiten mit Microsoft Clarity und Microsoft Advertising zusammen, um zu erfassen, wie Sie unsere Website nutzen und mit ihr interagieren, und zwar mithilfe von Verhaltensmetriken, Heatmaps und Sitzungswiederholungen, um unsere Produkte und Dienstleistungen zu verbessern und zu vermarkten. Die Nutzungsdaten der Website werden mithilfe von Cookies von Erst- und Drittanbietern und anderen Tracking-Technologien erfasst, um die Beliebtheit von Produkten/Dienstleistungen und Online-Aktivitäten zu ermitteln. Außerdem verwenden wir diese Informationen zur Optimierung der Website, zu Betrugs-/Sicherheitszwecken und für Werbung. Weitere Informationen darüber, wie Microsoft Ihre Daten sammelt und verwendet, finden Sie auf der Website [Microsoft Privacy Statement](https://privacy.microsoft.com/privacystatement)
