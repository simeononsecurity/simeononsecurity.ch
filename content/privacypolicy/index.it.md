...
I server pubblicitari di terze parti o le reti pubblicitarie utilizzano tecnologie come cookie, JavaScript o Web Beacon che vengono utilizzati nei rispettivi annunci e link che appaiono su SimeonOnSecurity e che vengono inviati direttamente al browser degli utenti. In questo caso, ricevono automaticamente l'indirizzo IP dell'utente. Queste tecnologie vengono utilizzate per misurare l'efficacia delle loro campagne pubblicitarie e/o per personalizzare il contenuto pubblicitario visualizzato sui siti web visitati.
...
Collaboriamo con Google AdSense e Analytics per ottimizzare la vostra esperienza sul sito, migliorare i nostri prodotti/servizi e commercializzare efficacemente le nostre offerte. Questi servizi prevedono l'utilizzo di cookie e altre tecnologie di tracciamento, sia di prima parte che di terze parti, per raccogliere dati sulle interazioni e sul comportamento dell'utente durante la navigazione sul nostro sito web.

Utilizzando Google AdSense, possiamo mostrarvi annunci mirati in base alle vostre precedenti visite al nostro sito web e ad altri siti web. Questa pubblicità personalizzata è resa possibile dall'uso di cookie pubblicitari. Inoltre, Google Analytics ci consente di raccogliere preziose informazioni sul traffico del sito web, sul coinvolgimento degli utenti e su altre metriche per migliorare le prestazioni del nostro sito.

Per garantire la trasparenza e il controllo delle proprie preferenze di personalizzazione degli annunci, è possibile visitare il sito web [Ads Settings](https://www.google.com/settings/ads) page to opt out of personalized advertising. Alternatively, you may choose to visit [www.aboutads.info](http://www.aboutads.info/choices/) per rifiutare la pubblicità personalizzata da parte di fornitori terzi che utilizzano i cookie. Si noti che se non si è optato per il servizio pubblicitario di terzi, anche altri fornitori e reti pubblicitarie possono utilizzare i cookie per visualizzare gli annunci sul nostro sito.

Poiché le politiche e le normative sulla privacy possono variare da paese a paese e da editore a editore, non siamo in grado di fornire un linguaggio specifico per la vostra politica sulla privacy. Tuttavia, consigliamo di consultare risorse quali [Network Advertising Initiative](http://www.networkadvertising.org/) or reviewing [cookiechoices.org](http://cookiechoices.org/) per una guida alla stesura di un'informativa sulla privacy completa.

Per ulteriori informazioni sulle modalità di raccolta e utilizzo dei dati da parte di Google attraverso AdSense e Analytics, si rimanda al documento [Google Privacy Policy](https://policies.google.com/privacy)

### Microsoft Clarity

*Collaboriamo con Microsoft Clarity e Microsoft Advertising per rilevare il modo in cui gli utenti utilizzano e interagiscono con il nostro sito web attraverso metriche comportamentali, heatmap e replay delle sessioni per migliorare e commercializzare i nostri prodotti/servizi. I dati di utilizzo del sito web vengono acquisiti utilizzando cookie di prima e terza parte e altre tecnologie di tracciamento per determinare la popolarità dei prodotti/servizi e l'attività online. Inoltre, Microsoft utilizza queste informazioni per l'ottimizzazione del sito, per scopi di frode/sicurezza e per la pubblicità. Per ulteriori informazioni sulle modalità di raccolta e utilizzo dei dati dell'utente da parte di Microsoft, visitare il sito web [Microsoft Privacy Statement](https://privacy.microsoft.com/privacystatement)
