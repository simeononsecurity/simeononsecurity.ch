...
Nous travaillons en partenariat avec Google AdSense et Analytics afin d'optimiser votre expérience sur le site web, d'améliorer nos produits/services et de commercialiser efficacement nos offres. Ces services impliquent l'utilisation de cookies et d'autres technologies de suivi, à la fois de première partie et de tierce partie, pour collecter des données sur vos interactions et votre comportement lorsque vous naviguez sur notre site web.

En utilisant Google AdSense, nous pouvons afficher des publicités ciblées en fonction de vos visites antérieures sur notre site web et d'autres sites web. Cette publicité personnalisée est rendue possible par l'utilisation de cookies publicitaires. En outre, Google Analytics nous permet de recueillir des informations précieuses sur le trafic du site web, l'engagement des utilisateurs et d'autres paramètres afin d'améliorer les performances de notre site.

Pour assurer la transparence et le contrôle de vos préférences en matière de personnalisation des annonces, vous pouvez consulter la page d'accueil de Google Analytics. [Ads Settings](https://www.google.com/settings/ads) page to opt out of personalized advertising. Alternatively, you may choose to visit [www.aboutads.info](http://www.aboutads.info/choices/) pour refuser la publicité personnalisée par des fournisseurs tiers qui utilisent des cookies. Veuillez noter que si vous n'avez pas choisi de ne pas recevoir de publicité de la part de tiers, d'autres fournisseurs et réseaux publicitaires peuvent également utiliser des cookies pour afficher des publicités sur notre site.

Les politiques et réglementations en matière de protection de la vie privée pouvant varier d'un pays à l'autre et d'un éditeur à l'autre, nous ne sommes pas en mesure de fournir une formulation spécifique pour votre politique de protection de la vie privée. Toutefois, nous vous recommandons de consulter des ressources telles que le [Network Advertising Initiative](http://www.networkadvertising.org/) or reviewing [cookiechoices.org](http://cookiechoices.org/) pour obtenir des conseils sur la rédaction d'une politique complète en matière de protection de la vie privée.

Pour plus d'informations sur la manière dont Google collecte et utilise les données par l'intermédiaire d'AdSense et d'Analytics, veuillez vous référer à la section [Google Privacy Policy](https://policies.google.com/privacy)

### Microsoft Clarity

*Nous travaillons en partenariat avec Microsoft Clarity et Microsoft Advertising pour déterminer comment vous utilisez et interagissez avec notre site web par le biais de mesures comportementales, de cartes thermiques et de reprises de session afin d'améliorer et de commercialiser nos produits/services. Les données relatives à l'utilisation du site web sont saisies à l'aide de cookies de première et de tierce parties et d'autres technologies de suivi afin de déterminer la popularité des produits/services et de l'activité en ligne. En outre, nous utilisons ces informations à des fins d'optimisation du site, de lutte contre la fraude, de sécurité et de publicité. Pour plus d'informations sur la manière dont Microsoft recueille et utilise vos données, consultez le site Web de Microsoft. [Microsoft Privacy Statement](https://privacy.microsoft.com/privacystatement)

## Droits de la protection de la vie privée de la CCPA (Ne pas vendre mes informations personnelles)

En vertu de la loi CCPA, les consommateurs californiens ont notamment le droit de.. :
de demander à une entreprise qui collecte les données personnelles d'un consommateur de divulguer les catégories et les éléments spécifiques des données personnelles qu'elle a collectées sur les consommateurs.
