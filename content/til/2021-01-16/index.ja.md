...
本日、SimeonOnSecurity は ImmersiveLabs で複数の防御および攻撃のラボを完了しました。また、次のトピックに関するビデオも視聴しました。

UniFi Protect G3 Instant - 開梱、レビュー、比較 (Crosstalk Solutions)
海賊、暗号通貨、そして Windows 製品アクティベーションの秘密の歴史 (Dave's Garage)
新しいCPUのリリース (LinusTechTips)
UniFi Protect (TechnoTim) に移行した理由
