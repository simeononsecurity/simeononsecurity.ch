...
Astăzi, SimeonOnSecurity a finalizat mai multe laboratoare defensive și ofensive pe ImmersiveLabs. De asemenea, au vizionat videoclipuri despre următoarele subiecte:

UniFi Protect G3 Instant - Unboxing, revizuire și comparare (Crosstalk Solutions)
Pirații, Crypto și istoria secretă a activării produselor Windows (Dave's Garage)
Lansarea unui nou procesor (LinusTechTips)
De ce cineva s-a mutat la UniFi Protect (TechnoTim)
