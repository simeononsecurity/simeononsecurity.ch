---
title: "Oggi ho imparato a far rispettare i criteri del Controllo applicazioni di Windows Defender (WDAC)"
date: 2021-01-04
toc: true
draft: false
description: ""
...
Oggi SimeonOnSecurity ha approfondito il tema dell'auditing e dell'applicazione dei criteri di Windows Defender Application Control (WDAC). WDAC è una funzione di Windows che aiuta a prevenire l'esecuzione di software non autorizzato o non attendibile su un dispositivo. Fornisce un mezzo per controllare quali applicazioni possono essere eseguite su un dispositivo, contribuendo così a migliorare la sicurezza complessiva del dispositivo.
