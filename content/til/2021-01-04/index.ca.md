---
title: "Avui he après a fer complir les polítiques de control d'aplicacions de Windows Defender (WDAC)."
date: 2021-01-04
toc: true
draft: false
description: ""
...
Avui, SimeonOnSecurity va aprofundir en el tema de l'auditoria i l'aplicació de les polítiques de control d'aplicacions de Windows Defender (WDAC). WDAC és una característica de Windows que ajuda a evitar que el programari no autoritzat o de confiança s'executi en un dispositiu. Proporciona un mitjà per controlar quines aplicacions es poden executar en un dispositiu, ajudant així a millorar la seguretat general del dispositiu.

## Auditoria i aplicació de polítiques de control d'aplicacions de Windows Defender (WDAC):
