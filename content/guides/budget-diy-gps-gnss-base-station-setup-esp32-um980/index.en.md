   ...
   1. Hotspot
      ...
      There are three ways to do this:
         ...
         3. Disable the hotspot entirely by toggling the WiFi hotspot section
            1. **Note**: *You will not be able to access the ESP32 XBee if there is a problem with it's connection to your home WiFi network, unless you perform a* [*Full Reset*](https://github.com/nebkat/esp32-xbee/wiki/Getting-Started/f89fa4ad06a50b2e248109c73be7c6389f9f1716#full-reset).
...
7. Extras
   1. Full Reset
      ...
      If this procedure does not work for any reason, another way to perform a full reset is to follow the [Firmware Update](https://github.com/nebkat/esp32-xbee/wiki/Firmware-Update) procedure and including the `wipe_config.bin` file as described.
