---
title: "Автоматизируйте соответствие домена Windows с помощью объектов групповой политики, совместимых со STIG."
date: 2020-09-08
---
...
```
Сценарий, который мы будем использовать, должен быть запущен из каталога, содержащего все остальные файлы из каталога.[GitHub Repository](https://github.com/simeononsecurity/STIG-Compliant-Domain-Prep)
