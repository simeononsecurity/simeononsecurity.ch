---
title: "SolarWinds Orion サプライ チェーン攻撃: C2、軽減策、および専門家のガイダンス"
date: 2020-12-14
toc: true
draft: false
description: "C2 マルウェア、軽減策、DHS や FireEye などの組織からの専門家のガイダンスなど、SolarWinds Orion サプライ チェーン攻撃について学びます。"
tags: ["ソーラーウィンズ", "サプライチェーン", "C2", "コマンドと制御", "緩和策", "ガイダンス", "脅威インテリジェンス", "DHS", "ファイアアイ", "MSRC", "マイクロソフト", "サンズ", "SolarWinds.Orion.Core.BusinessLayer.dll", "SolarWinds.BusinessLayerHost.exe", "構成ウィザード.exe", "NetflowDatabaseMaintenance.exe", "NetFlowService.exe", "SolarWinds.Administration.exe", "SolarWinds.Collector.Service.exe", "DNS CNAME", "IP範囲", "DNS名"]
---

ソーラーウィンド問題に関するガイダンスについては、以下を参照してください。[DHS](https://cyber.dhs.gov/ed/21-01/), [SolarWinds](https://www.solarwinds.com/securityadvisory), [FireEYE](https://www.fireeye.com/blog/threat-research/2020/12/evasive-attacker-leverages-solarwinds-supply-chain-compromises-with-sunburst-backdoor.html), [MSRC](https://msrc-blog.microsoft.com/2020/12/13/customer-guidance-on-recent-nation-state-cyber-attacks/), and [Microsoft](https://www.microsoft.com/en-us/wdsi/threats/malware-encyclopedia-description?Name=Trojan:MSIL/Solorigate.B!dha) 

上級ユーザーの方はこちらをご覧ください。[FireEYE Countermeasures Repo](https://github.com/fireeye/sunburst_countermeasures) この問題について。

SANS にはこのトピックに関する優れたビデオがあります[here](https://www.youtube.com/watch?v=4tmlZCk2gCg&feature=youtu.be)

## 実行可能ファイル:
問題のDLLは```SolarWinds.Orion.Core.BusinessLayer.dll``` and was signed as a ligitimate part of the SolarWinds suite, bypassing application control technologies. It is installed as a service.
