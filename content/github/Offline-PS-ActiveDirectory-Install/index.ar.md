...
  قم بتثبيت وحدة PowerShell RSAT ActiveDirectory دون اتصال  ### كيفية تثبيت: 1. [تنزيل النص النص] (https://github.com/simeononsecurity/Offine-PS-ActiveDirectory-Install/archive/master.zip) 2. من المجلد المستخرج ، شغّل "". \ sos-offlinepsadinstall.ps1 "" 