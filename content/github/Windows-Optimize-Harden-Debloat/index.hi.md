...
संगठन पसंद करते हैं[PrivacyTools.io](https://PrivacyTools.io), [Microsoft](https://microsoft.com), [Cyber.mil](https://public.cyber.mil), the [Department of Defense](https://www.defense.gov/), and the [National Security Agency](https://www.nsa.gov/) लॉकडाउन, कठोर और ऑपरेटिंग सिस्टम को सुरक्षित करने के लिए कॉन्फ़िगरेशन परिवर्तनों की सिफारिश की है। इन परिवर्तनों में टेलीमेट्री, मैक्रोज़ को अवरुद्ध करने, ब्लोटवेयर को हटाने और सिस्टम पर कई डिजिटल और भौतिक हमलों को रोकने सहित शमन की एक विस्तृत श्रृंखला शामिल है। इस स्क्रिप्ट का उद्देश्य उन संगठनों द्वारा अनुशंसित कॉन्फ़िगरेशन को स्वचालित करना है।
