---
title: "Servidor web Apache segur: una guia completa per a administradors de sistemes"
date: 2020-07-27
---
 Una col·lecció d'exemples de configuracions i scripts per ajudar els administradors del sistema a reforçar els servidors web Apache.

Apache, fora de la caixa, és sorprenentment insegur. Moltes de les millors pràctiques i configuracions de seguretat s'han de configurar manualment abans de llançar Apache en un entorn de producció. Podeu utilitzar aquest dipòsit de GitHub com a punt de partida per assegurar les vostres instàncies d'Apache.


## Instal·lació de ModSecurity amb el conjunt de regles bàsiques d'OWASP

### Pas 1: actualitza els repositoris
**A Ubuntu/Debian:**
```
