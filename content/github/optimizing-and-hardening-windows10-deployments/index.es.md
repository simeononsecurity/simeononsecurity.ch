...
Organizaciones como [PrivacyTools.io](https://PrivacyTools.io), [Microsoft](https://microsoft.com), [Cyber.mil](https://public.cyber.mil), the [Department of Defense](https://www.defense.gov/), and the [National Security Agency](https://www.nsa.gov/) han recomendado cambios de configuración para bloquear, endurecer y proteger el sistema operativo. Estos cambios cubren una amplia gama de mitigaciones, incluyendo el bloqueo de telemetría, macros, eliminación de bloatware, y la prevención de muchos ataques digitales y físicos en un sistema. Este script pretende automatizar las configuraciones recomendadas por esas organizaciones.
