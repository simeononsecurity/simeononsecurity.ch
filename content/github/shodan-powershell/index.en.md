...
{{< figure src="download.gif" alt="On the project page click the code button which opens the dropdown menu containing clone, Open with Github Desktop, Download Zip. Select the copy icon next to the clone url" >}}
...
{{< figure src="copyasadmin.png" alt="Open file explorer path C:\Program Files\WindowsPowerShell\Modules , copy dialog says access is denied, click on continue to copy the files" >}}
...
{{< figure src="downloadzip.gif" alt="On the project page click the code button which opens the dropdown menu containing clone, Open with Github Desktop, Download Zip. Select Download Zip option" >}}
...
{{< figure src="RcRunAsAdmin.gif" alt="Right click the powershell icon on the Desktop and select run as administrator from dropdown menu" >}}
...
{{< figure src="SearchBarRunAsAdmin.gif" alt="type p in the search bar and when powershell comes up click on run as administrator" >}}
