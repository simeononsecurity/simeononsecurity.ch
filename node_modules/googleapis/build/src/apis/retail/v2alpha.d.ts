...
export declare namespace retail_v2alpha {
    ...
    export class Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createMerchantCenterAccountLink(params: Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink, options: StreamMethodOptions): GaxiosPromise<Readable>;
        createMerchantCenterAccountLink(params?: Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
        createMerchantCenterAccountLink(params: Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createMerchantCenterAccountLink(params: Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        createMerchantCenterAccountLink(params: Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        createMerchantCenterAccountLink(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks$Createmerchantcenteraccountlink extends StandardParameters {
        /**
         * Output only. Immutable. Full resource name of the Merchant Center Account Link, such as `projects/x/locations/global/catalogs/default_catalog/merchantCenterAccountLinks/merchant_center_account_link`.
         */
        name?: string;
